...
new #[Layout('components.layouts.guest')] class extends Component {
    public string $email = '';
    public string $matricula = ''; // O protótipo pedia matrícula também, mas o breeze reseta só por email. Deixo aqui para não quebrar.
    ...
    <div class="w-full max-w-[450px] relative z-10">
        ...
        <div class="bg-brand-brown rounded-3xl p-8 shadow-2xl relative overflow-hidden">
            ...
            <div class="text-center mb-8 mt-2">
                ...
                <p class="text-white/60 text-sm mt-2 font-medium">Esqueceu sua senha? Não tem problema. Informe seu email abaixo e enviaremos instruções.</p>
            </div>
            ...
            <form wire:submit="sendPasswordResetLink" class="flex flex-col gap-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input wire:model="email" type="email" placeholder="seu@email.com.br" required class="w-full bg-white/5 border border-white/10 focus:border-brand-yellow focus:bg-white/10 text-white rounded-xl px-4 py-3 pl-11 outline-none transition-all font-medium placeholder:text-white/30">
        ...
        <div class="text-center mt-8 relative z-20">
            <a href="{{ route('site.index') }}" class="text-brand-brown font-bold text-sm hover:underline hover:text-black transition-colors flex items-center justify-center gap-1">
